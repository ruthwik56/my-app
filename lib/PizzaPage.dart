              ...
              children: [
                GestureDetector( onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                      return FoodItemBottomSheet(quantity: 0, name: 'Veg pizza', price: 10,description:"Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice.");
                    }
                  );
                },
                  child: FoodItem(item:'Veg pizza',description: 'Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice ',price:'\₹ 10',image: 'assets/images/Biryani.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Chicken pizza", price:12,description:"Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice.");
                  });
                },
                  child: FoodItem(item:'Chicken pizza',description: 'Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice.',price:'\₹ 12',image: 'assets/images/Biryani1.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Paneer pizza", price: 13,description:"Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice.");
                  });
                },
                  child: FoodItem(item:'Paneer pizza',description: 'Crispy crust, heavenly bites. A slice of heaven. Mouthwatering, slice after slice.',price:'\₹ 13',image: 'assets/images/Cake1.jpeg',)),
