              ...
              children: [
                GestureDetector( onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                      return FoodItemBottomSheet(quantity: 0, name: 'Paneer butter masala', price: 40,description:"Paneer butter masala is very tasty");
                    }
                  );
                },
                  child: FoodItem(item:'Paneer butter masala',description: 'Taste our Paneer butter masala it is very delicious',price:'\₹ 40',image: 'assets/images/Biryani.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Egg fry", price: 25,description:"Egg fry is very tasty");
                  });
                },
                  child: FoodItem(item:'Egg fry',description: 'Taste our egg fry it is very delicious',price:'\₹ 25',image: 'assets/images/Biryani1.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Palak paneer", price: 30,description:"Palak paneer is very tasty");
                  });
                },
                  child: FoodItem(item:'Palak paneer',description: 'Taste our Palak paneer it is very delicious',price:'\₹ 30',image: 'assets/images/Cake1.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Butter chicken", price: 50,description:"Butter chicken is very tasty");
                  });
                },
                  child: FoodItem(item:'Butter chicken',description: 'Taste our Butter chicken it is very delicious',price:'\₹ 50',image: 'assets/images/Sprite1.jpeg',)),
                GestureDetector(onTap: () {
                  showModalBottomSheet(context: context, builder: (BuildContext context){
                    return FoodItemBottomSheet(quantity: 0, name: "Chiken curry", price: 40,description:"Chicken curry is very tasty");
                  });
                },
                  child: FoodItem(item:'Chicken curry',description: 'Taste our Chicken curry it is very delicious',price:'\₹ 40',image: 'assets/images/Paneer1.jpeg',)),
              ],
            ),
          ),
        ],
